...
public class JobProducer {
  ...
  private String sceneURI, loader;
  ...
  private static boolean runFromMain = false;
	...
	public void setSceneLoader(String loader) { this.loader = loader; }
	public String getSceneLoader() { return this.loader; }
	
	public String getHost() {
		if (this.host == null) {
			Server s = Client.getCurrentClient().getServer();
			
			if (s.getPeers().length <= 0) {
				return "localhost";
			} else {
				return s.getPeers()[0];
			}
	...
	public String sendTask() {
		RayTracingJobFactory f = null;
		
		if (this.loader != null) {
			f = new RayTracingJobFactory(this.sceneURI, this.w, this.h,
										this.ssw, this.ssh, this.jobSize, this.jobId);
		} else {
			f = new RayTracingJobFactory(this.sceneURI, this.loader, this.w, this.h,
										this.ssw, this.ssh, this.jobSize, this.jobId);
		}
