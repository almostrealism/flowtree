...
public class NetworkDialog extends JPanel {
  ...
  private JList serverList;
	...
	public NetworkDialog() {
		...
		this.portField.setValue(new Integer(NetworkDialog.defaultPort));
		this.nodesField.setValue(new Integer(NetworkDialog.defaultTotalNodes));
		this.peersField.setValue(new Integer(NetworkDialog.defaultPeers));
		this.jobsField.setValue(new Integer(NetworkDialog.defaultJobs));
		this.outputPortField.setValue(new Integer(NetworkDialog.defaultOutputPort));
	...
	public void updateFields() {
		...
		this.portField.setValue(new Integer(this.client.getServer().getPort()));
		this.nodesField.setValue(new Integer(this.client.getServer().getNodeGroup().getNodes().length));
		this.peersField.setValue(new Integer(this.client.getServer().getNodeGroup().getNodes()[0].getMaxPeers()));
		this.jobsField.setValue(new Integer(this.client.getServer().getNodeGroup().getNodes()[0].getMaxJobs()));
		this.outputHostField.setText(this.client.getOutputHost());
		this.outputPortField.setValue(new Integer(this.client.getOutputPort()));
	}
