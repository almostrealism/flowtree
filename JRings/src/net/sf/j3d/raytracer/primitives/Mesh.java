...
package net.sf.j3d.raytracer.primitives;
...
import net.sf.j3d.raytracer.engine.Intersection;
import net.sf.j3d.raytracer.engine.Ray;
import net.sf.j3d.raytracer.engine.RayTracingEngine;
import net.sf.j3d.raytracer.engine.SpacePartition;
...
public class Mesh extends SpacePartition {
  ...
  private VertexData vertexData;
	 ...
	 * @return  The Traingle object requested.
	 */
	...
	/**
	 * @see net.sf.j3d.raytracer.engine.Surface#intersect(net.sf.j3d.raytracer.engine.Ray)
	 */
	...
	/**
	 * @see net.sf.j3d.raytracer.engine.Surface#intersectAt(net.sf.j3d.raytracer.engine.Ray)
	 */
...
//		} else {
//			throw new IllegalArgumentException("Cannot add " + s.getClass().getName() + " to Mesh.");
//		}
	}
